...
const plans = [
  {
    ...
    features: [
      ...
      { text: "50 pedidos/mês", included: true },
      { text: "1 mensagem de recuperação", included: true },
      { text: "Upsell de produtos", included: true },
      { text: "Recuperação de carrinho", included: true },
      { text: "Mensagens personalizadas", included: false },
  ...
  },
  {
    ...
    popular: false,
    features: [
      { text: "20 produtos", included: true },
      { text: "200 pedidos/mês", included: true },
      { text: "3 mensagens de recuperação", included: true },
      { text: "Upsell de produtos", included: true },
      { text: "Recuperação de carrinho", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "1.000 pedidos/mês", included: true },
      { text: "5 mensagens de recuperação", included: true },
      { text: "Upsell de produtos", included: true },
      { text: "Recuperação de carrinho", included: true },
      { text: "Mensagens personalizadas", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Múltiplos bots", included: true },
